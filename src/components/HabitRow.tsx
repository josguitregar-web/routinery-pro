  ...
  return (
    <motion.div
      ...
      className={`group relative flex items-center justify-between p-4 rounded-xl border transition-all duration-200 cursor-pointer select-none ${
        isCompleted
          ? 'bg-[#0A0A0A] border-[#FF0000]/30 shadow-[0_0_15px_rgba(255,0,0,0.08)]'
          : 'bg-[#0A0A0A] border-[#1A1A1A] hover:border-[#2A2A2A] hover:bg-[#0E0E0E]'
      }`}
    >
      {/* Left indicator accent line */}
      <div
        className={`absolute left-0 top-3 bottom-3 w-[2px] rounded-r transition-colors duration-200 ${
